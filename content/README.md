...
| 顺序 | 条目 | 为什么这样排 |
|------|------|-------------|
| 57 | [赛季与修改器](entries/seasons.md) | 三种档案（持久 / 赛季 / PvE）与赛季规则 |
| 58 | [赛季修改器逐项](entries/season-modifiers.md) | 全局 6 项 + 33 张个人卡的点数市场 |
| 59 | [联赛系统](entries/leagues.md) | 每周 50 人的经验值天梯 |
| 60 | [竞技场](entries/arena.md) | 独立进度的纯对抗模式 |

### 第七篇：场景与转场（把一局打成一条线）

| 顺序 | 条目 | 为什么这样排 |
|------|------|-------------|
| 61 | [转场与 BTR](entries/transit.md) | 不结束战局也能换图，经验倍率与物流通道 |
| 62 | [撤离点详解](entries/extraction-points.md) | 条件型撤离点速查：钥匙、信号弹、合作、付费 |

### 第八篇：世界规则（最后补上环境这一层）

| 顺序 | 条目 | 为什么这样排 |
|------|------|-------------|
| 63 | [天气与时间系统](entries/weather.md) | 七倍速时钟、进图两个档位与天气的双向作用 |
| 64 | [光照与夜战](entries/lighting.md) | 光源是双刃剑：照亮与被照亮只差一秒 |
