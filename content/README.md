...
| 5 | [保险机制](entries/insurance.md) | 新手最容易被忽略的“后悔药”，决定了你敢带什么进图（赛季中可能被禁用） |
| 6 | [背包与容器系统](entries/inventory.md) | 安全箱与背包管理，是收益差距的第一来源 |
| 7 | [安全箱与容器](entries/containers.md) | 六个安全箱型号的尺寸与获取路径，以及专用容器怎么扩仓库 |
| 8 | [PMC 与 Scav](entries/pmc-scav.md) | 弄清两条命、两套规则，Scav 是新手的免费练习券 |

### 第二篇：地图（按体量从小到大）

| 顺序 | 条目 | 为什么这样排 |
|------|------|-------------|
| 9 | [工厂](entries/factory.md) | 最小最乱的 CQB 图，练近战的课堂 |
| 10 | [海关](entries/customs.md) | 经典中的经典，任务最密集的中型图 |
| 11 | [森林](entries/woods.md) | 大型开阔图，狙击与听声辨位的考场 |
| 12 | [海岸线](entries/shoreline.md) | 疗养院垂直攻防与远距离交火并存 |
| 13 | [立交桥](entries/interchange.md) | 全室内商城，光线昏暗、背身刺杀频发 |
| 14 | [储备站](entries/reserve.md) | 军事基地与地下掩体，高价值任务枢纽 |
| 15 | [实验室](entries/labs.md) | 无 Scav、全 PMC 的顶级风险区 |
| 16 | [地面零点](entries/ground-zero.md) | 面向低等级玩家的市区图，任务起点 |
| 17 | [灯塔](entries/lighthouse.md) | 重做后的海岸军事图，Lightkeeper 线起点 |
| 18 | [街区](entries/streets.md) | 全游戏最大的城市图，双 Boss 与地雷区 |
| 19 | [终点站](entries/terminal.md) | 1.0 主线压轴，剧情向的终局场景 |
| 20 | [破冰船](entries/icebreaker.md) | 全 PvE 终局场景，辐射与黑师 |
| 21 | [迷宫](entries/labyrinth.md) | 不在选图列表里的解谜型场景，保险不生效 |

### 第三篇：装备与枪械（看懂数值，才知道为什么死）

| 顺序 | 条目 | 为什么这样排 |
|------|------|-------------|
| 22 | [弹药与穿深等级](entries/ammo.md) | **塔科夫第一真理：子弹比枪重要** |
| 23 | [弹药选型速查表](entries/ammo-table.md) | 按对手的护甲等级反推今天带哪盒弹 |
| 24 | [弹道与穿透机制](entries/ballistics.md) | 穿深、护甲伤害、有效性衰减的底层规则 |
| 25 | [护甲与头盔](entries/armor.md) | 护甲等级、材质与耐久，护住哪里才划算 |
| 26 | [护甲与头盔图鉴](entries/armor-catalog.md) | 载体 + 软质层 + 插板的三层结构与代表型号 |
| 27 | [护甲修复与耐久](entries/armor-repair.md) | 上限只降不升：什么时候该修、什么时候该换 |
| 28 | [武器故障与耐久维护](entries/weapon-maintenance.md) | 卡壳不是运气，是耐久与过热的账 |
| 29 | [医疗物资](entries/medical.md) | 止血、复位、手术包的取舍与携带逻辑 |
| 30 | [枪械改装](entries/gunsmith.md) | 人机工效、后坐力、精度的改装三角 |
| 31 | [枪械图鉴](entries/weapons.md) | 按口径与枪型选主武器，先弹后枪 |
| 32 | [服装与外观](entries/clothing.md) | 不挡子弹，但影响别人的第一次判断 |
| 33 | [钥匙与钥匙房](entries/keys.md) | 消耗品属性与房间价值的换算 |

### 第四篇：经济与成长（把每一条命变成资产）

| 顺序 | 条目 | 为什么这样排 |
|------|------|-------------|
| 34 | [商人系统](entries/traders.md) | 八位商人各有分工，声望就是购买力（1.1 起售价整体上调） |
| 35 | [以物换物](entries/barter.md) | 物品换物品：怎么把配方材料折算成钱再决定值不值 |
| 36 | [跳蚤市场](entries/flea-market.md) | 玩家经济的中枢，变现与捡漏的主战场 |
| 37 | [跳蚤定价与手续费](entries/flea-pricing.md) | 费率公式、底价反推与定价算法 |
| 38 | [邮件与领取](entries/mail.md) | 保险返还、货款与奖励的取件柜——会过期 |
| 39 | [藏身处](entries/hideout.md) | 离线收益与被动技能，穷人的复利 |
| 40 | [藏身处模块详解](entries/hideout-modules.md) | 二十余个模块的功能与建造优先级 |
| 41 | [任务系统](entries/quests.md) | 1.1 后改为忠诚度解锁，Kappa 门槛同步降低 |
| 42 | [商人任务线图鉴](entries/trader-questlines.md) | 八条任务线的特征、代表任务与回报 |
| 43 | [剧情章节与主线任务](entries/story-chapters.md) | Tour / Falling Skies / The Ticket：主线分叉与四个结局 |
...
| 59 | [遇敌处置与接战决策](entries/contact-drill.md) | 遇到人的前 3 秒：打、躲，还是走 |
