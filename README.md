...
系统性介绍《逃离塔科夫》（Escape from Tarkov）地图、机制、装备与经济系统的中文开源项目。目前已收录 **74 个**条目，分八篇：入门机制、地图、装备与枪械、经济与成长、进阶战斗机制、赛季与衍生内容、场景与转场、世界规则，覆盖全部常用地图、弹药护甲枪械、商人任务与藏身处、Boss 图鉴与护卫编队、AI 行为逻辑、赛季修改器、敌我识别、阵营交战规则与遇敌处置。
...
| `content/entries/` | 百科条目页（共 74 篇，分八篇） |
