...
系统性介绍《逃离塔科夫》（Escape from Tarkov）地图、机制、装备与经济系统的中文开源项目。目前已收录 **80 个**条目，分九篇：入门机制、地图、装备与枪械、经济与成长、进阶战斗机制、赛季与衍生内容、场景与转场、世界与背景、战局内行为手册，覆盖全部常用地图、弹药护甲枪械、商人任务与藏身处、Boss 图鉴与护卫编队、AI 行为逻辑、赛季修改器、敌我识别、阵营交战规则，以及一个战局从进图到撤离、再到交火中每一个动作的全流程。
...
| `content/entries/` | 百科条目页（共 80 篇，分九篇） |
